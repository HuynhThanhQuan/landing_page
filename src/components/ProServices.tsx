...
const SERVICES: { id: string; Icon: LucideIcon; accent: string }[] = [
  {
    id: "consulting",
    Icon: Compass,
  ...
  return (
    <section id="services" className="cm-section">
            ...
            >
              ...
              <div className="relative cm-card-pad">
                <div className="flex items-start justify-between">
                  <div
                    className="w-12 h-12 grid place-items-center rounded-xl border border-[var(--line)] text-[var(--accent)]"
                  ...
                  {[1, 2, 3].map((n) => {
                    ...
                    return (
                      <li key={n} className="flex items-start gap-2 text-sm text-[var(--ink-2)]">
                        <ArrowRight size={14} className="text-[var(--accent)] mt-1 shrink-0" aria-hidden />
                        <span>{item}</span>
                      </li>
                    );
                  })}
      ...
      <div className="mt-16">
        ...
        <div className="overflow-hidden border-y border-[var(--line)] py-6" aria-hidden>
